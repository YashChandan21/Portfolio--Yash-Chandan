...
const experiences = [
  {
    ...
    duration: "Jan 2025 – September 2025",
    description:
    ...
    icon: (
      <FaLaptopCode className="text-blue-600 dark:text-blue-400 text-3xl" />
    ),
    gradient: "from-blue-300 to-blue-500",
    stack: "React.js, Tailwind CSS, Shadcn.ui",
    link: "https://www.threadsnatch.online/",
  },
  {
    role: "Web Developer",
    ...
    stack: "google site, google App console",
    link: "https://www.dmagician.in/",
  },
  {
        ...
        {experiences.map((exp, i) => (
          ...
          >
            ...
            >
              ...
              <time className="block text-xs text-gray-500 dark:text-gray-400 mb-4">
                {exp.duration}
              </time>
