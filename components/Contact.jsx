...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "cc6001ad-f6c7-4b3a-a4ad-943ae3a9cb7e");
  ...
  return (
    ...
    transition={{delay:1.3,duration: 0.6}}
        ...
        transition={{duration: 0.3}}
          className="py-3 px-8 w-max flex items-center justify-center gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 cursor-pointer dark:bg-transparent dark:border-[0.5px] dark:hover:bg-[#2a004a]"
          type="submit"
        >
          Submit now{" "}
