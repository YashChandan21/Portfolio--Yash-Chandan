...
export const serviceData = [
  {
    ...
    title: "Web design",
    description: "Creating modern web layouts that are visually appealing, brand-aligned, and fully responsive across devices.  ..",
    link: "",
  },
  {
    ...
    description:
      "Developing complete web applications with responsive frontends, efficient backends, and seamless database integration...",
    link: "",
  },
  {
    icon: assets.ui_icon,
    title: "UI/UX design",
    description:
      "Designing intuitive interfaces and user journeys focused on usability, accessibility, and smooth interaction...",
    link: "",
  },
  {
    icon: assets.graphics_icon,
    title: "Website Maintenance & Updates",
    description: "Managing updates, fixing issues, and ensuring websites stay secure, fast, and fully functional...",
    link: "",
  },
];
